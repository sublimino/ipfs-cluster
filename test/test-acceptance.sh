...
K8S_MASTER_SSH_CREDENTIALS_BASE64=''

SSH_CREDENTIALS_BASE64=""

DOCKER_REGISTRY_CREDENTIALS_PSW=''
DOCKER_REGISTRY_CREDENTIALS_USR=''
...
fetch_kubeconfig_from_k8s_master() {
  trap "rm -rf '${TMP_SSH_KEYFILE}' /tmp/admin.conf" EXIT
